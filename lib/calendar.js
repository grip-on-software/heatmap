...
class calendar {
    ...
    // or "per-developer", showing the color for the commits divided by the number of developers
    setMode(mode = "per-developer") {      
    ...
    resetDomain() {
        ...
        for (let date in this.commitData) {
            if (this.config.mode === "per-developer") {
