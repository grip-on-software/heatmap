...
function calendar(projectKey = "", commits = [], weather = []) {
    ...
    dayGroups.on('mouseover', day => tooltip.show(formatDate(day), `${data[formatDate(day)]} commits<br>${weather[formatDate(day)]} °C`))
