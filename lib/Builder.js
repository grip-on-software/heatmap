        ...
        const projectsNavigation = new navigation({
            ...
            addElement: (element) => {
                element.style("width", "0%")
                    ...
                    .attr('data-tooltip', d => this.locales.message("project-title",
            ...
            .on("click", (d, element, buttons) => {
                if (this.currentCalendar) {
                    ...
                    d3.select(buttons[element])
                        .attr("data-tooltip", enabled ? enable : disable)
        ...
        const dataNavigation = new navigation({
            ...
            addElement: (element) => {
                element.text(d => this.locales.attribute("data-title", d))
                    ...
                    .attr('data-tooltip', d => this.locales.attribute("data-description", d));
            }
        });
